...
def rumor_component_distribution(sf, related, membership, component_col='hier_id'):
    ...
    def top_level_report(self, sf, top_n=10):
        ...
        for h in hier_sf:
            ...
            cur_sf = self.sf[self.sf['hier_id'] == h['hier_id']]
            terms = {}
            ...
            top_bigrams['top_bigrams'].append(ranked[:top_n])
